...
books = ['Пушкин Александр Сергеевич#Евгений Онегин', 'Ершов#Конек-горбунок',
...
for i in books:
       ...
       try:
              result, _ =curve_fit(funct, np.arange(min(NUMBER,len(toConsider))) + 1, y,
                            p0 = [1000, -1, -1, 1, 1],
       ...
       plt.scatter(range(len(y)), y, s = 5, label = lab)
